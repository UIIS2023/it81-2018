...
public class Donut extends Circle {
	...
	public Donut(Point center, int outerRadius, int innerRadius) throws Error {
		...
		{
			throw new Error("Inner radius can't be smaller than outer radius!");
		}
	}
	
	public Donut(Point center, int outerRadius, int innerRadius, Color outlineColor, Color fillColor) throws Error {
		super(center,outerRadius);
		if(innerRadius < outerRadius)
		{
			this.innerRadius = innerRadius;
	...
	public Donut(Point center, int outerRadius, int innerRadius, boolean selected) throws Error {
